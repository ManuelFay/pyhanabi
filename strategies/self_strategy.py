"""SelfRecognitionPlayer strategy implementation."""
...
class SelfRecognitionPlayer(AbstractStrategy):
    """Self-recognition strategy."""
    def __init__(self, name, pnr, other=None):
        self.name = name
        self.hints = {}
        self.pnr = pnr
        self.gothint = None
        ...
        self.last_board = []
        if other is None:
            from strategies.outer_strategy import OuterStatePlayer
            other = OuterStatePlayer
        self.other = other
        self.explanation = []
